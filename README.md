# FT Stockpickers Tracker
Tracker built to track the Financial Times Stockpickers from October 3rd 2025 to present.

## Launching
Open the terminal set to your python enviornment, set to folder with py scripts and launch using code in term_code text code.
